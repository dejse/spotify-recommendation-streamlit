...
st.dataframe(pipeline.show_song_details(con, track_id))

st.markdown("## Recommendations")
recommendations = pipeline.make_recommendations(con, track_id)
